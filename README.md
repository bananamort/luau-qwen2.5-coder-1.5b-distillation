...
| **[`stress_train.ipynb`](notebooks/stress_train.ipynb)** | A100 GPU | Worst-case **4×4** VRAM ceiling stress test (100% 2048-token saturated sequences) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bananamort/luau-qwen2.5-coder-1.5b-distillation/blob/main/notebooks/stress_train.ipynb) |
| **[`stress_prep_data.ipynb`](notebooks/stress_prep_data.ipynb)** | CPU | Generate 600 unpadded 2048-token saturated stress test samples $\rightarrow$ Hugging Face | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bananamort/luau-qwen2.5-coder-1.5b-distillation/blob/main/notebooks/stress_prep_data.ipynb) |
| **[`probe_topk_mass.ipynb`](notebooks/probe_topk_mass.ipynb)** | Free T4 / A100 GPU | **~1 min** analytical Top-K probability mass probe over real prepped dataset | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/bananamort/luau-qwen2.5-coder-1.5b-distillation/blob/main/notebooks/probe_topk_mass.ipynb) |
...
| **`BATCH_SIZE`** | `4` | Micro-batch size per GPU forward pass ($\sim 21.1\text{ GB}$ peak VRAM on A100) |
